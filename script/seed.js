...
async function seed() {
  ...
  const products = await Promise.all([
    Product.create({ name: 'Fish Tacos', description: 'Amazingly yummy', ingredients: ['tacos', 'fish'], price: 8.50, timeToPrep: 30, availability: 'available', numberInStock: 45, calories: 750 }),
    Product.create({ name: 'Jalapeno Burgers', description: 'Amazingly yummy', ingredients: ['ground beef', 'bun', 'onion', 'spice mix', 'pickles', 'jack cheese', 'ketchup'], price: 9.00, timeToPrep: 35, availability: 'available', numberInStock: 45, calories: 650 }),
    Product.create({ name: 'Asian Salad', description: 'Amazingly yummy', ingredients: ['tacos', 'fish'], price: 10.95, timeToPrep: 2, availability: 'available', numberInStock: 45, calories: 755 }),
    Product.create({ name: 'Grandmas\'s Chicken Noodel Soup', description: 'Amazingly yummy', ingredients: ['tacos', 'fish'], price: 9.95, timeToPrep: 60, availability: 'available', numberInStock: 18, calories: 755 }),

    Product.create({ name: 'Shrimp Scampi with Pasta', description: 'Well-rounded seafood and pasta dish. Good with any pasta.', ingredients: ['shrimp', 'fish'], price: 9.00, timeToPrep: 30, availability: 'available', numberInStock: 120, calories: 850 }),

    Product.create({ name: 'Rigatoni alla Genovese', description: 'Slow-simmered perfection! Sure, this old school recipe flies in the face of the convention that recipes must be, above all, quick, but the proof is in the process—and it’s an easy one! After rendering some pork fat from pancetta, brown your beef chuck in the fat, then add celery and carrot and seasonings, a little white wine, and finally, count them, 6 pounds of sliced onions! Everything gets cooked down and reduced over 10 hours until all the intermingled flavors become something akin to pure poetry in a pasta sauce. Serve with rigatoni or your favorite pasta. Get the recipe for Rigatoni alla Genovese.', ingredients: ['pancetta', 'beef chuck', 'celery', 'carrot', 'tomato paste'], price: 11.00, timeToPrep: 35, availability: 'available', numberInStock: 64, calories: 800 }),

    Product.create({ name: 'Arroz Con Pollo', description: 'Wonderful homey chicken dish. This is a recipe from a relative in Panama. Fluff the rice carefully.', ingredients: ['tacos', 'fish'], price: 12.95, timeToPrep: 30, availability: 'available', numberInStock: 45, calories: 755 }),

    Product.create({ name: 'Roasted Asparagus Salda with Feta Cheese', description: 'Yummy.', ingredients: ['tacos', 'fish'], price: 8.00, timeToPrep: 25, availability: 'available', numberInStock: 53, calories: 600 }),
